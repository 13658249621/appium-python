...
def test_login(driver):
    ...
    el10 = driver.find_element(by=AppiumBy.XPATH,
                               value="//android.widget.TextView[@resource-id=\"com.hpbr.bosszhipin:id/tv_title\" and @text=\"牛人可联系\"]")
    el10.click()
    ...
    element = driver.find_element("xpath", '//android.widget.TextView[@text="手机"]/following-sibling::*[2]')
    print(f"获取到的元素: {element}")
    element.click()
